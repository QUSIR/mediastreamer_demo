...
extern "C" {
#endif
extern void write_error_log(const char *format, ...);
extern void write_warning_log(const char *format, ...);
extern void write_message_log(const char *format, ...);
#ifdef __cplusplus
}
#endif

#define ms_warning	write_warning_log
#define ms_error	write_error_log
#define ms_fatal	write_error_log
