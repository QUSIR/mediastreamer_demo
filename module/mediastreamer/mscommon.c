...
#include "mediastreamer/alldescs.h"
#include "mssndcard.h"
#include "mswebcam.h"
...
#if 0//defined(ANDROID) && defined (VIDEO_ENABLED)
	if (1) {
...
#elif defined(__MACH__) && defined(__GNUC__) && defined(__GNUC_UP3__) || defined(ANDROID)
	struct timeval tv;
